...
AddressService.prototype.transactionOutputHandler = function(messages, tx, outputIndex, rejected) {
  ...
  if (!addressInfo) {
    console.log("transactionOutputHandler: ", script, "addressInfo false");
    return;
  }

  console.log("transactionOutputHandler: ", script, "addressInfo true", addressInfo);
...
AddressService.prototype.transactionHandler = function(txInfo, callback) {
  ...
  console.log('AddressService.prototype.transactionHandler txinfo:  ', txInfo);
